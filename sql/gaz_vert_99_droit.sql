...
-- Tables : met_env.m_env_gaz_vert_canton_ressource
GRANT ALL ON TABLE met_env.m_env_gaz_vert_canton_ressource TO "pre-sig-usr";
GRANT SELECT ON TABLE met_env.m_env_gaz_vert_canton_ressource TO "pre-sig-ro";
